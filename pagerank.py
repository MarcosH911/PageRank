...
def transition_model(corpus, starting_page, damping_factor):
    """
    ...
    for page in corpus[starting_page]:
        probability_distribution[page] += damping_factor / len(corpus[starting_page])
